...
public class TaskProviderDatabase extends ContentProvider {
    public static final String log_tag = "TaskProviderDb";
...
//                    sortOrder = databaseHelper.COLUMN_TITLE_ID + " ASC";
//                }
                break;
            case URI_TASK_ID:
                ...
                if(TextUtils.isEmpty(selection)){
                    selection = selection + " AND " +databaseHelper.COLUMN_TASK_ID + " = " + id;
                }
                break;
            default:
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        db = databaseHelper.getWritableDatabase();
        long rowID = db.insert(databaseHelper.TABLE_TASK, null, values);
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        switch (uriMathcher.match(uri)){
            ...
            case URI_TASK_ID:
                ...
                Log.d(log_tag, "URI_TASK_ID = "+ id);
                if(TextUtils.isEmpty(selection)){
                    selection =  databaseHelper.COLUMN_TASK_ID + " = " + id;
                }
                else{
                    selection = selection + " AND " +databaseHelper.COLUMN_TASK_ID + " = " + id;
                }
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        int rowCount = db.update(databaseHelper.TABLE_TASK, values, selection, selectionArgs);
