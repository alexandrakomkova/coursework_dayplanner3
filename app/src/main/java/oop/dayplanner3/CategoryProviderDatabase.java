...
public class CategoryProviderDatabase extends ContentProvider {
    static final String log_tag = "CategoryProviderDb";
        ...
        switch (uriMathcher.match(uri)){
            case URI_CATEGORIES:
                ...
                if(TextUtils.isEmpty(sortOrder)){
                    sortOrder = databaseHelper.COLUMN_CATEGORY_TITLE + " ASC";
                }
                break;
            case URI_CATEGORY_ID:
                ...
                if(TextUtils.isEmpty(selection)){
                    selection = selection + " AND " +databaseHelper.COLUMN_CATEGORY_ID + " = " + id;
                }
                break;
            default:
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        db = databaseHelper.getWritableDatabase();
        long rowID = db.insert(databaseHelper.TABLE_CATEGORY, null, values);
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        switch (uriMathcher.match(uri)){
            ...
            case URI_CATEGORY_ID:
                ...
                Log.d(log_tag, "URI_CATEGORY_ID = "+ id);
                if(TextUtils.isEmpty(selection)){
                    selection =  databaseHelper.COLUMN_CATEGORY_ID + " = " + id;
                }
                else{
                    selection = selection + " AND " +databaseHelper.COLUMN_CATEGORY_ID + " = " + id;
                }
        ...
        int rowCount = db.delete(databaseHelper.TABLE_CATEGORY, selection, selectionArgs);
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        int rowCount = db.update(databaseHelper.TABLE_CATEGORY, values, selection, selectionArgs);
